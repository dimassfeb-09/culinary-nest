    ...
    <>
          ...
          <div className="absolute bottom-0 translate-y-14 find-city shadow-2xl md:h-40 rounded-3xl md:w-1/2 bg-white">
            <div className="flex items-center justify-between mx-20 my-8">
              ...
              <div className="flex gap-5">
                <div className="px-5 rounded-md bg-primary text-white">Destination</div>
                <div className="px-5 rounded-md bg-primary text-white">Explore</div>
              </div>
            </div>
            <div className="mx-20 h-10 border-2 border-black rounded-full flex items-center px-5">
              <img src="/assets/logos_google-maps.png" alt="maps" className="h-6 w-6"/>
              <div className="border-l-2 h-5 mx-2"></div>
              <input className="w-full ml-2 outline-0" type="text" placeholder="Bali"/>
            </div>
          </div>
        </div>
      </div>
      <div className="flex  translate-y-20 px-20 justify-center items-center ">
        ...
        <div className="w-1/2 ">
          ...
          <div className="text-lg text-justify ">Discover the perfect dining spot that matches your taste, budget, and preferences with trusted reviews, a variety of delicious dishes, and exclusive discounts all in one place.</div>
        </div>
      </div>
    </>
  );
